...
var DatabaseItemFinder = /** @class */ (function () {
    function DatabaseItemFinder() {
    }
    DatabaseItemFinder.prototype.findItemsMatchingSearchString = function (searchString) {
    ...
    DatabaseItemFinder.prototype.findUserItems = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            var userItems, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
    ...
    return DatabaseItemFinder;
}());
exports.default = DatabaseItemFinder;
